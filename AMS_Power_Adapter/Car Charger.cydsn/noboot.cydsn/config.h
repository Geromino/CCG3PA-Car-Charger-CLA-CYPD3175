 ...
 */
    ...
    #else
    #ifdef CYPD3175
        #define RED_LED_GPIO_PORT_PIN                           (GPIO_PORT_2_PIN_0)
        #define GREEN_LED_GPIO_PORT_PIN                         (GPIO_PORT_2_PIN_1)
    #endif
#endif
...
#define APP_KEEP_ALIVE                                  (1u)
#define APP_SDK_FUNC_MSG_VALUE                          (1u)
#define APP_SDK_FUNC_MSG                                (0u)
#define APP_EVENT_MSG                                   (1u)
#define APP_POWER_PDM_MSG                               (0u)
#define APP_POWER_RT_MSG                                (1u)
/*
